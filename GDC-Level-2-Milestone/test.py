...
class SimpleTest(unittest.TestCase):
    ...
    def test_add_tasks(self):
        self.assert_stdout(
            "add", ["5", "Test Task 5"], 'Added task: "Test Task 5" with priority 5'
        )
    ...
    def test_add_same_tasks(self):
        self.assert_stdout(
            "add", ["2", "Task 3"], 'Added task: "Task 3" with priority 2'
        )
        self.assert_stdout(
            "add", ["2", "Task 2"], 'Added task: "Task 2" with priority 2'
        )
        tasks = load_tasks_file()
    ...
    def test_add_complete_tasks(self):
        self.assert_stdout(
            "add", ["10", "Task 10"], 'Added task: "Task 10" with priority 10'
        )
    ...
    def test_delete_tasks(self):
        self.assert_stdout(
            "add", ["15", "Task 15"], 'Added task: "Task 15" with priority 15'
        )
    ...
    def test_delete_nonexisting_tasks(self):
        self.assert_stdout(
            "delete",
            ["1500"],
            "Error: item with priority 1500 does not exist. Nothing deleted.",
        )
